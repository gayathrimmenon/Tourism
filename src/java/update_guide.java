 ...
 */
public class update_guide extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String Experience=request.getParameter("experience");
              ...
              try
            {
                ...
                PreparedStatement ps = con.prepareStatement("update guide set name=?,age=?,address=?,country=?,email=?,qualification=?,experiances=?,contact=? where login=?");
