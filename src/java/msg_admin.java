 ...
 */
public class msg_admin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet msg_guide</title>");            
            out.println("</head>");
            out.println("<body>");
             try
            {
                ...
                PreparedStatement ps = con.prepareStatement("insert into msg_admin values(?,?,?,?)");
